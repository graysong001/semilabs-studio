...
const AssumptionDiagnosticProvider_1 = require("./AssumptionDiagnosticProvider");
suite('AssumptionDiagnosticProvider Test Suite', () => {
    let provider;
    setup(() => {
        provider = new AssumptionDiagnosticProvider_1.AssumptionDiagnosticProvider();
    });
    teardown(() => {
        provider.dispose();
    });
 ...
 */
async function createMockDocument(content, fileName, languageId) {
...
//# sourceMappingURL=AssumptionDiagnosticProvider.test.js.map