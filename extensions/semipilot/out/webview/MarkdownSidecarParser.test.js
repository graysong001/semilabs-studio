...
\`\`\`
    `.trim();
        const result = (0, MarkdownSidecarParser_1.parseMarkdownSidecar)(content);
        // 验证: hasSidecar = true
...
\`\`\`
    ...
    test('should handle empty string', () => {
        const result = (0, MarkdownSidecarParser_1.parseMarkdownSidecar)('');
        assert.strictEqual(result.hasSidecar, false);
        assert.strictEqual(result.cleanContent, '');
    });
});
//# sourceMappingURL=MarkdownSidecarParser.test.js.map